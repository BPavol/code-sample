...
class CssUrlsFilter
{
	 ...
	 */
	public function __construct($docRoot, $basePath = '/', \Nette\Http\IRequest $httpRequest = null)
	{
		...
		$this->basePath = $httpRequest ? rtrim($httpRequest->getUrl()->getBasePath(), '/') : $basePath;
	}
